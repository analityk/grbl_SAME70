...
static void report_util_axis_values(float *axis_value) {
  ...
  for (idx=0; idx<N_AXIS; idx++){
	serial_write("XYZCBA"[idx]); serial_write(':');
...
void report_alarm_message(uint8_t alarm_code)
{
	...
	{
		printPgmString("Crash Prevented! Pls Reonnect and Re-home");
	}
	else
	{
...
void report_firmware()
{
	...
	printPgmString("FIRMWARE_NAME:Grbl, FIRMWARE_URL:https://github.com/openpnp/grbl, FIRMWARE_VERSION: " GRBL_VERSION "\r\n");
}
